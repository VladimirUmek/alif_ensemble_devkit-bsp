...
* @version  v1.0.0
* @date     10-7-2024
* @brief   	Pin MUX and Pin Config settings for "DevKit Gen 2 (DK-E7)" project with AE722F80F55D5LS
* @bug      None.
* @note     To modify this file manually make sure you have good knowledge of the board schematics! In many cases board_defs.h must be modified too.
******************************************************************************/
...
const struct pinconf board_pinconf[] = {
	...
	/* Selected: UT1_T0_A */
	{PORT_0, PIN_2, PINMUX_ALTERNATE_FUNCTION_4, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: LPCAM_XVCLK_B for CAMERA_XVCLK */
	{PORT_0, PIN_3, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_BUS_REPEATER | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P0_4 on pin R10. Functions: [0]: GPIO0_4, [1]: OSPI0_D4_A, [2]: UART1_RX_A, [3]: PDM_D0_A, [4]: I2C1_SDA_A, [5]: >>>UT2_T0_A<<<, [6]: CAN_RXD_B, [7]: ANA_S4 */
	/* Selected: UT2_T0_A */
	{PORT_0, PIN_4, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P0_5 on pin N15. Functions: [0]: GPIO0_5, [1]: OSPI0_D5_A, [2]: UART1_TX_A, [3]: PDM_C0_A, [4]: I2C1_SCL_A, [5]: >>>UT2_T1_A<<<, [6]: CAN_TXD_B, [7]: ANA_S5 */
	/* Selected: UT2_T1_A */
	{PORT_0, PIN_5, PINMUX_ALTERNATE_FUNCTION_5, PADCTRL_READ_ENABLE | PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: UART2_TX_A for UART1 */
	{PORT_1, PIN_1, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: UART0_RX_B for CLICKBOARD_UART */
	...
	/* Selected: UART0_TX_B for CLICKBOARD_UART */
	{PORT_1, PIN_5, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: OSPI0_RXDS_B for OSPI Hyper PSRAM */
	{PORT_1, PIN_6, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_READ_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: OSPI0_D0_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_D1_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_D2_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_D3_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_D4_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_D5_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_D6_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_D7_B for OSPI Hyper PSRAM */
	...
	/* Selected: OSPI0_SCLK_B for OSPI Hyper PSRAM */
	{PORT_3, PIN_0, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_SLEW_RATE_FAST | PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA},
	...
	/* Selected: OSPI0_SCLKN_B for OSPI Hyper PSRAM */
	{PORT_3, PIN_1, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_SLEW_RATE_FAST | PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA},

	/* P3_2 on pin E2. Functions: [0]: GPIO3_2, [1]: >>>OSPI0_SS0_B<<<, [2]: PDM_D1_B, [3]: I2S1_SDI_A, [4]: I3C_SDA_C, [5]: QEC0_Z_A, [6]: LPCAM_D6_B, [7]: CAM_D6_A */
	/* Selected: OSPI0_SS0_B for OSPI Hyper PSRAM */
	...
	/* Selected: I2C0_SCL_B for CLICKBOARD_I2C */
	...
	/* Selected: I2C0_SDA_B for CLICKBOARD_I2C */
	...
	/* P3_6 on pin V5. Functions: [0]: GPIO3_6, [1]: HFXO_OUT_A, [2]: LPUART_CTS_B, [3]: >>>LPPDM_C1_B<<<, [4]: SPI0_SS2_B, [5]: I2C1_SDA_B, [6]: QEC2_X_A, [7]: CAM_D10_A */
	/* Selected: LPPDM_C1_B for LPPDM_TEST */
	{PORT_3, PIN_6, PINMUX_ALTERNATE_FUNCTION_3, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: LPPDM_D1_B for LPPDM_TEST */
	...
	/* Selected: OSPI1_SCLK_C for OSPI FLASH */
	{PORT_5, PIN_5, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_SLEW_RATE_FAST | PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA},

	/* P5_6 on pin B12. Functions: [0]: GPIO5_6, [1]: UART1_CTS_B, [2]: I2C2_SCL_C, [3]: >>>UT3_T0_B<<<, [4]: SD_D6_A, [5]: ETH_RXD1_A, [6]: CDC_VSYNC_A */
	/* Selected: UT3_T0_B for CLICKBOARD_PWM */
	...
	/* Selected: OSPI1_SS0_C for OSPI FLASH */
	...
	/* Selected: ETH_TXD0_A for ETH_PHY */
	{PORT_6, PIN_0, PINMUX_ALTERNATE_FUNCTION_6, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: PDM_C2_A for PDM_MIC */
	{PORT_6, PIN_7, PINMUX_ALTERNATE_FUNCTION_3, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P7_0 on pin B8. Functions: [0]: GPIO7_0, [1]: Reserved, [2]: CMP3_OUT_A, [3]: SPI0_MISO_C, [4]: I2C0_SDA_C, [5]: UT8_T0_B, [6]: >>>SD_CMD_A<<<, [7]: CAN_RXD_A */
	/* Selected: SD_CMD_A for SD_CARD */
	...
	/* Selected: SD_CLK_A for SD_CARD */
	{PORT_7, PIN_1, PINMUX_ALTERNATE_FUNCTION_6, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_BUS_REPEATER | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: I2C1_SDA_C for CAMERA_I2C */
	...
	/* Selected: I2C1_SCL_C for CAMERA_I2C */
	...
	{PORT_7, PIN_5, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_READ_ENABLE | PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: I3C_SDA_D for IMU_GYRO_ACCEL */
	...
	/* Selected: I3C_SCL_D for IMU_GYRO_ACCEL */
	...
	/* Selected: OSPI1_SCLKN_C for OSPI FLASH */
	{PORT_8, PIN_0, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_SLEW_RATE_FAST | PADCTRL_OUTPUT_DRIVE_STRENGTH_12MA},
	...
	{PORT_8, PIN_1, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_READ_ENABLE | PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	{PORT_8, PIN_4, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_READ_ENABLE | PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	{PORT_8, PIN_5, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_READ_ENABLE | PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P8_6 on pin J2. Functions: [0]: GPIO8_6, [1]: Reserved, [2]: >>>I2S3_SCLK_B<<<, [3]: QEC0_Z_B, [4]: LPCAM_D6_A, [5]: SD_D6_C, [6]: CDC_D6_A, [7]: CAM_D6_B */
	/* Selected: I2S3_SCLK_B for I2S_MIC */
	{PORT_8, PIN_6, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_BUS_REPEATER | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P8_7 on pin J1. Functions: [0]: GPIO8_7, [1]: Reserved, [2]: >>>I2S3_WS_B<<<, [3]: QEC1_X_B, [4]: LPCAM_D7_A, [5]: SD_D7_C, [6]: CDC_D7_A, [7]: CAM_D7_B */
	/* Selected: I2S3_WS_B for I2S_MIC */
	{PORT_8, PIN_7, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P9_0 on pin K2. Functions: [0]: GPIO9_0, [1]: Reserved, [2]: >>>I2S3_SDI_B<<<, [3]: QEC1_Y_B, [4]: SD_CMD_C, [5]: CDC_D8_A, [6]: CAM_D8_B */
	/* Selected: I2S3_SDI_B for I2S_MIC */
	...
	/* P9_3 on pin H5. Functions: [0]: >>>GPIO9_3<<<, [1]: HFXO_OUT_B, [2]: UART7_RX_B, [3]: I2S3_SDO_A, [4]: SPI2_MOSI_B, [5]: QEC2_Y_B, [6]: CDC_D11_A, [7]: CAM_D11_B */
	...
	/* Selected: OSPI1_D0_C for OSPI FLASH */
	...
	/* Selected: OSPI1_D1_C for OSPI FLASH */
	...
	/* Selected: OSPI1_D2_C for OSPI FLASH */
	...
	/* Selected: OSPI1_D3_C for OSPI FLASH */
	...
	/* Selected: OSPI1_D4_C for OSPI FLASH */
	...
	/* Selected: OSPI1_D5_C for OSPI FLASH */
	...
	/* Selected: OSPI1_D6_C for OSPI FLASH */
	...
	/* Selected: OSPI1_D7_C for OSPI FLASH */
	...
	/* Selected: ETH_TXD1_B for ETH_PHY */
	{PORT_10, PIN_5, PINMUX_ALTERNATE_FUNCTION_6, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: ETH_TXEN_B for ETH_PHY */
	{PORT_10, PIN_6, PINMUX_ALTERNATE_FUNCTION_6, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P10_7 on pin P1. Functions: [0]: GPIO10_7, [1]: >>>OSPI1_RXDS_C<<<, [2]: UART7_RX_A, [3]: I2S2_SCLK_B, [4]: SPI3_SCLK_B, [5]: I2C1_SCL_D, [6]: UT3_T1_C, [7]: CDC_D23_A */
	/* Selected: OSPI1_RXDS_C for OSPI FLASH */
	...
	/* Selected: ETH_REFCLK_B for ETH_PHY */
	...
	/* Selected: ETH_MDIO_B for ETH_PHY */
	...
	/* Selected: ETH_MDC_B for ETH_PHY */
	{PORT_11, PIN_2, PINMUX_ALTERNATE_FUNCTION_6, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: ETH_RXD0_B for ETH_PHY */
	...
	/* Selected: ETH_RXD1_B for ETH_PHY */
	...
	/* Selected: ETH_CRS_DV_B for ETH_PHY */
	...
	/* Selected: ETH_RST_B for ETH_PHY */
	{PORT_11, PIN_6, PINMUX_ALTERNATE_FUNCTION_6, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: ETH_IRQ_B for ETH_PHY */
	...
	/* Selected: UART4_TX_B for UART2 */
	{PORT_12, PIN_2, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* Selected: SPI3_MISO_A for CLICKBOARD_SPI */
	{PORT_12, PIN_4, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_READ_ENABLE | PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P12_5 on pin A10. Functions: [0]: GPIO12_5, [1]: Reserved, [2]: >>>SPI3_MOSI_A<<<, [3]: UT10_T1_C, [4]: CAN_TXD_C, [5]: CDC_D13_B */
	/* Selected: SPI3_MOSI_A for CLICKBOARD_SPI */
	{PORT_12, PIN_5, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P12_6 on pin E5. Functions: [0]: GPIO12_6, [1]: Reserved, [2]: >>>SPI3_SCLK_A<<<, [3]: UT11_T0_C, [4]: CAN_STBY_C, [5]: CDC_D14_B */
	/* Selected: SPI3_SCLK_A for CLICKBOARD_SPI */
	{PORT_12, PIN_6, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P12_7 on pin D2. Functions: [0]: GPIO12_7, [1]: OSPI1_RXDS_B, [2]: Reserved, [3]: >>>SPI3_SS0_A<<<, [4]: UT11_T1_C, [5]: CDC_D15_B */
	/* Selected: SPI3_SS0_A for CLICKBOARD_SPI */
	{PORT_12, PIN_7, PINMUX_ALTERNATE_FUNCTION_3, PADCTRL_DRIVER_DISABLED_PULL_UP | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P13_0 on pin G18. Functions: [0]: GPIO13_0, [1]: OSPI1_D0_B, [2]: Reserved, [3]: SPI3_SS1_A, [4]: >>>QEC0_X_C<<<, [5]: SD_D0_B, [6]: CDC_D16_B */
	/* Selected: QEC0_X_C for QEC */
	...
	/* Selected: LPI2S_SDI_C for LPI2S */
	...
	/* Selected: LPI2S_SDO_C for LPI2S */
	{PORT_13, PIN_5, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P13_6 on pin B15. Functions: [0]: GPIO13_6, [1]: OSPI1_D6_B, [2]: >>>LPI2S_SCLK_C<<<, [3]: QEC2_X_C, [4]: SD_D6_B, [5]: CDC_D22_B */
	/* Selected: LPI2S_SCLK_C for LPI2S */
	{PORT_13, PIN_6, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P13_7 on pin A15. Functions: [0]: GPIO13_7, [1]: OSPI1_D7_B, [2]: >>>LPI2S_WS_C<<<, [3]: QEC2_Y_C, [4]: SD_D7_B, [5]: CDC_D23_B */
	/* Selected: LPI2S_WS_C for LPI2S */
	{PORT_13, PIN_7, PINMUX_ALTERNATE_FUNCTION_2, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
	...
	/* P14_3 on pin R7. Functions: [0]: >>>GPIO14_3<<<, [1]: OSPI1_SS1_B, [2]: UART7_TX_C, [3]: Reserved, [4]: QEC3_Z_C */
	/* Selected: GPIO14_3 for UTIMER_GPO0 */
	{PORT_14, PIN_3, PINMUX_ALTERNATE_FUNCTION_0, PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},

	/* P14_4 on pin R8. Functions: [0]: >>>GPIO14_4<<<, [1]: CMP3_OUT_B, [2]: SPI1_MISO_C, [3]: FAULT0_C */
	/* Selected: GPIO14_4 for UTIMER_GPO1 */
	...
	/* Selected: GPIO14_5 for UTIMER_GPO2 */
	...
	/* Selected: GPIO14_6 for UTIMER_GPO3 */
	...
	{PORT_14, PIN_7, PINMUX_ALTERNATE_FUNCTION_1, PADCTRL_SCHMITT_TRIGGER_ENABLE | PADCTRL_OUTPUT_DRIVE_STRENGTH_4MA},
